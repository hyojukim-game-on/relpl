...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .addFilterBefore(new JwtFilter(jwtTokenProvider, exceptionHandler).disableAuth("/api/usr/token/reissue", "/api/user/isExist/uid", "/api/user/isExist/phone", "/api/user/isExist/nickname/**"), UsernamePasswordAuthenticationFilter.class)
